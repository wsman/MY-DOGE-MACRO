...
export const SettingsPanel: React.FC<SettingsPanelProps> = ({ onClose }) => {
  const { theme, setTheme, sidebarOpen, toggleSidebar, statusBarVisible, toggleStatusBar } = useUIStore();
      ...
      <div className="settings-content">
        ...
        <section className="settings-section">
          ...
          <div className="setting-item">
            <label>状态栏</label>
            <button
              className={statusBarVisible ? 'active' : ''}
        ...
        <section className="settings-section">
          ...
          <div className="about-info">
            <p><strong>MY-DOGE-MICRO</strong></p>
            <p>版本: v1.0.0</p>
